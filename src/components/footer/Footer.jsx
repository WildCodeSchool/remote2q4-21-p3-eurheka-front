    ...
    return (
        <div className='Footer'>
            <div className='logo-container'>
                <NavLink to="/">
                    <img className='footer-logo' src={Logo_Icone_Jaune} alt="Eurheka logo" />
                </ NavLink>
            </div>
            ...
            <div className='socials'>
                <div className='icons-container'>
                    ...
                    <a href="https://www.facebook.fr" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-facebook-f fa-2xl"></i></a>
